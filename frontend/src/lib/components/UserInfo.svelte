...
<div class="user-info">
    ...
    <div class="balance-details">
        ...
        <div class="balance-item">
            ...
            <span class="amount"
                >{formatCurrency(balance.restock_unclaimed)}</span
            >
        </div>
...
<style>
    ...
    .balance-details {
        ...
        gap: 16px;
        /* balance-itemの親要素の幅を監視対象にする */
        container-type: inline-size;
        container-name: balance-container;
    }
    ...
    @container balance-container (min-width: 782px) {
        .balance-item.total {
            /* 3列表示できるときはフルサイズを解除する */
            grid-column: auto;
        }
    }
